 ...
 */
public class GrayTransformer extends AbstractTransformer{
    ...
    public GrayTransformer(ExecutorTransformer executorTransformer,TimerTaskTransformer timerTaskTransformer,ForkJoinTransformer forkJoinTransformer){
